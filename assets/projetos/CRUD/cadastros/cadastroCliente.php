		...
		<div class=" row">
			...
			<div class="col">
				<form action="#" method="POST">
					...
					<div class="mb-3">
						<label for="cpf" class="form-label" style="color: #BFA36F; font-weight: 800;">CPF</label>
						<input type="number" class="form-control" id="cpf" name="cpf" maxlength="11" require>
					</div>
					<div class="mb-3">
						<label for="rg" class="form-label" style="color: #BFA36F; font-weight: 800;">RG</label>
						<input type="number" class="form-control" id="rg" name="rg" maxlength="9" require>
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="nimber" class="form-control" id="tel" name="tel" maxlength="11">
					</div>
					<div class="mb-3">
...
if (!empty($_POST)) {
	...
	$arquivo = fopen("consultas/cadastro/cliente.txt", "a+") or die("Não foi possivel abrir o arquivo!");
