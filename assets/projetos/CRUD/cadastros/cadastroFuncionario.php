...
<body style="background-color: #344B59;">
	<div class="container">
		<h1 class="text-center text-white" style="background-color: #1D2F40" ; ">CADASTRO DE FUNCIONARIO</h1>
		<br>
		<div class=" row">
			<div class="col">
			...
			<div class="col">
				<form action="#" method="POST">
					<div class="mb-3">
						<label for="nome" class="form-label" style="color: #BFA36F; font-weight: 800;" require>Nome</label>
						<input type="text" class="form-control" id="nome" name="nome">
					</div>
					<div class="mb-3">
						<label for="cpf" class="form-label" style="color: #BFA36F; font-weight: 800;" require>CPF</label>
						<input type="number" class="form-control" id="cpf" name="cpf" maxlength="11">
					</div>
					<div class="mb-3">
						<label for="cargo" class="form-label" style="color: #BFA36F; font-weight: 800;">Cargo</label>
						<input type="text" class="form-control" id="cargo" name="cargo">
					</div>
					<div class="mb-3">
						<label for="salario" class="form-label" style="color: #BFA36F; font-weight: 800;">salario</label>
						<input type="number" class="form-control" id="salario" name="salario" maxlength="8">
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<input type="number" class="form-control" id="tel" name="tel" maxlength="11">
					</div>
					<div class="mb-3">
...
if (!empty($_POST)) {
	...
	$arquivo = fopen("consultas/cadastro/funcionario.txt", "a+") or die("Não foi possivel abrir o arquivo!");
